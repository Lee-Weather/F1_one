...
| exp0.11 | 2026-08-11 | 回退 exp0.5 配置，放宽约束并小幅推步长/相位；首次 900 轮被终止，bipay 重跑中 | 训练中 | TASK_20260812_002 | bipay43147@barumart.com | model_3000.pt |
...
### 7. 实验结果
> 首次训练任务 TASK_20260811_282 在 900 轮被平台终止（checkpoint model_900.pt），改用 bipay 账号重跑 TASK_20260812_002。
> 待重跑完成、回放并分析 CSV 后补充。
