...
| exp0.22 | 2026-08-13 | exp0.21 基础上温和化：feet_yaw 2.0→1.0、clearance 1.5→1.2、feet_height 1.2→1.0，保持真实脚朝向测量 | 训练中 | TASK_20260813_072 | limxmspwpf4mh2aijb@emalupe.com | - |
...
| --- | --- | --- | --- | --- |
| 机身高度 | 0.596m | 0.5927m | ~0.61m | ✅ |
| 平均速度 | 0.344 m/s | 0.3372 m/s | ≈0.5 | ❌ |
| 左/右周期 | 0.533/0.533s | 0.509/0.632s | 0.55~0.85s | ❌ |
| 左/右步频 | 1.875/1.875 | 1.963/1.582 | 1.2~1.8 | ❌/✅ |
| 左/右步长 | 0.183/0.183m | 0.172/0.213m | >=0.30m | ❌ |
| 左/右抬脚 | 0.013/0.045m | 0.019/0.044m | >=0.03m | ❌/✅ |
| 左/右脚朝向(真实) | - | 1.894/-1.223 rad | ≈0 | ❌ |
| 相位偏移 | 0.188 | 0.140 | ~0.5 | ❌ |

**结论**：❌ 未达标。hip_yaw 目标 0 约束未修复步态（速度/周期/步长/相位全面退化，与 exp0.19 同水平）。
**新增异常信号**：回放中 base_vel_yaw≈0.155 rad/s 持续，base_yaw 从 0.95 漂移到 -2.97（机器人整体在转圈！），真实 foot_yaw（wrap 后）L=1.89/R=-1.22 rad，脚朝向严重偏移。
